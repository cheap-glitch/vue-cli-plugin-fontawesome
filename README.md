...
Using Font Awesome in a Vue.js project is already pretty simple, but you still
have to use a verbose and repetitive syntax in order to benefit from
tree-shaking and include only the needed icons in the final bundle. This tiny
plugin allows you to manage your icons sets directly from your `vue.config.js`
...
The prompt will ask you which icon sets you want to be automatically included
 ...
 * [vue-fontawesome](https://github.com/FortAwesome/vue-fontawesome) (the official Vue component for Font Awesome
...
module.exports = {
	pluginOptions: {
		fontawesome: {
			// Defines the name of the Font Awesome component inside Vue templates (optional, defaults to 'fa')
			component: 'fa-icon',
