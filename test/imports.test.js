const { generate, wrapExpected } = require('./helpers');

test("imports nothing if no sets or icons are given to import", () => { // {{{

	expect(generate({ imports: [] })).toEqual('');
	expect(generate({ imports: {} })).toEqual('');

}); // }}}

test("imports the Vue components", () => { // {{{

	// Just the icon component
	expect(generate({
		component: 'font-awesome-icon',
		imports:   ['@fortawesome/pro-solid-svg-icons'],
	})).toEqual(wrapExpected(`
...
test("imports collections of icons", () => { // {{{
...
test("imports the same icon from different sets", () => { // {{{
...
test("imports different icons from different sets", () => { // {{{
...
test("imports icons from a single set", () => { // {{{
...
test("imports a single icon from multilple sets", () => { // {{{
...
test("imports several icons from multilple sets", () => { // {{{
